...
<body>
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6><span class="icon_tag_alt"></span> Have a coupon? <a href="shoping-cart.php#co">Click here</a> to enter your code
                    </h6>
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    ...
                                    <li><?php echo $row_cart['Name'] ?><span>$<?php echo $row_cart['Total'] ?></span></li>
                                    <?php } ?>
                                </ul>
                                <?php $show_coupon = mysqli_query($conn, "SELECT * FROM cart");
                                $show_cart2 = mysqli_query($conn, "SELECT SUM(Total) as sum FROM cart");
                                $row_cart2 = mysqli_fetch_array($show_cart2) ?>
                                <?php $c = mysqli_fetch_assoc($show_coupon) ?>
                                <div class="checkout__order__subtotal">Coupons <span><?php echo $c['Coupons'] ?>%</span></div>
                                <div class="checkout__order__total">Total <span>$<?php echo ($row_cart2['sum']*((100+$c['Coupons'])/100)) ?></span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        <h5><a href="shoping-cart.php#co" id="acc-or" class="col-lg-12">
                                            Remove or Add a coupon?</a></h5>
                                        <!-- <span class="checkmark"></span> -->
                                    </label>
                                </div>
